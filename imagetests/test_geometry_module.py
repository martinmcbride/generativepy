...
class TestGeometryImages(unittest.TestCase):
    def test_markers(self):
        def draw(ctx, width, height, frame_no, frame_count):
            ...
            Marker(ctx).of_points(a, b).as_dot(size).fill(red)

            a = (100, 50)
            b = (150, 150)
            Line(ctx).of_start_end(a, b).stroke(red, thickness)
            Marker(ctx).of_points(a, b, 0).as_dot(size).fill(red)

            a = (250, 50)
            b = (200, 150)
            Line(ctx).of_start_end(a, b).stroke(red, thickness)
            Marker(ctx).of_points(a, b, 1).as_dot(size).stroke(red, thickness)
            ...
            ## Draw lines with parallel markers
            a = (50, 450)
            b = (50, 550)
            Line(ctx).of_start_end(a, b).stroke(red, thickness)
    ...
    def test_old_markers(self):
        def draw(ctx, width, height, frame_no, frame_count):
            ...
            AngleMarker(ctx).of_points(a, b, c).with_radius(24).with_gap(
                6
            ).as_right_angle().stroke(red, thickness)

            a = (250, 250)
            b = (200, 450)
            c = (300, 450)
            Polygon(ctx).of_points((a, b, c)).open().stroke(red, thickness)
            AngleMarker(ctx).of_points(a, b, c).with_count(3).with_radius(24).with_gap(
                6
            ).stroke(red, thickness)
            ...
            c = (500, 300)
            Polygon(ctx).of_points((a, b, c)).open().stroke(red, thickness)
            AngleMarker(ctx).of_points(c, b, a).with_radius(24).with_gap(6).stroke(
                red, thickness
            )
            ...
            c = (500, 400)
            Polygon(ctx).of_points((a, b, c)).open().stroke(red, thickness)
            AngleMarker(ctx).of_points(a, b, c).with_count(2).with_radius(24).with_gap(
                6
            ).stroke(red, thickness)
    ...
    def test_line_segment(self):
        def draw(ctx, width, height, frame_no, frame_count):
            ...
            for i in range(9):
                ...
                Circle(ctx).of_center_radius(a, 0.1).fill(Color(0))
    ...
    def test_line_styles(self):
        def draw(ctx, width, height, frame_no, frame_count):
            ...
            Rectangle(ctx).of_corner_size((0.5, 1), 1, 1.2).stroke(
                Color(0, 0.5, 0), 0.1, dash=[0.25]
            )
            Rectangle(ctx).of_corner_size((2, 1), 1, 1.2).stroke(
                Color(0, 0.5, 0), 0.1, dash=[0.25], cap=BUTT
            )
            Rectangle(ctx).of_corner_size((3.5, 1), 1.2, 1).stroke(
                Color(0, 0.5, 0), 0.1, dash=[0.25], cap=ROUND
            )
            Rectangle(ctx).of_corner_size((0.5, 3), 1, 1.2).stroke(
                Color(0, 0.5, 0), 0.1, join=ROUND
            )
            Rectangle(ctx).of_corner_size((2, 3), 1, 1.2).stroke(
                Color(0, 0.5, 0), 0.1, join=BEVEL
            )
            Rectangle(ctx).of_corner_size((3.5, 3), 1.2, 1).stroke(
                Color(0, 0.5, 0), 0.1, miter_limit=1
            )
    ...
    def test_ellipse(self):
        def draw(ctx, width, height, frame_no, frame_count):
            ...
            Ellipse(ctx).of_center_radius((4, 1), 0.7, 0.3).as_arc(0, 1).stroke(
                Color(0, 0.5, 0), 0.05
            )

            Ellipse(ctx).of_center_radius((1, 2.5), 0.7, 0.3).as_sector(1, 3).stroke(
                Color("orange"), 0.05
            )
            Ellipse(ctx).of_center_radius((2.5, 2.5), 0.7, 0.3).as_sector(2, 4.5).fill(
                Color("cadetblue")
            )
            Ellipse(ctx).of_center_radius((4, 2.5), 0.7, 0.3).as_sector(2.5, 6).fill(
                Color("yellow")
            ).stroke(Color("magenta"), 0.05)

            Ellipse(ctx).of_center_radius((1, 4), 0.7, 0.3).as_segment(1, 3).stroke(
                Color("orange"), 0.05
            )
            Ellipse(ctx).of_center_radius((2.5, 4), 0.7, 0.3).as_segment(2, 4.5).fill(
                Color("cadetblue")
            )
    ...
    def test_complex_paths(self):
        def draw(ctx, width, height, frame_no, frame_count):
            ...
            ctx.save()
            ctx.translate(0, 0)
            Rectangle(ctx).of_corner_size((20, 20), 60, 60).fill(Color("red")).stroke(
                Color("blue"), 10
            )
            ctx.restore()
            ...
            ctx.save()
            ctx.translate(100, 0)
            Rectangle(ctx).of_corner_size((20, 20), 60, 60).stroke(
                Color("blue"), 10
            ).fill(Color("red"))
            ctx.restore()
            ...
            Rectangle(ctx).of_corner_size((30, 30), 60, 60).as_sub_path().fill(
                Color("red")
            ).stroke(Color("blue"), 5)
            ctx.restore()
            ...
            Line(ctx).of_end((30, 50)).extend_path().fill(Color("red")).stroke(
                Color("blue"), 5
            )
            ctx.restore()
            ...
            Line(ctx).of_start_end((20, 20), (60, 30)).add()
            Line(ctx).of_end((60, 60)).extend_path().add()
            Line(ctx).of_end((30, 50)).extend_path(close=True).fill(
                Color("red")
            ).stroke(Color("blue"), 5)
            ctx.restore()
            ...
            ctx.save()
            ctx.translate(0, 200)
            Circle(ctx).of_center_radius((20, 20), 10).as_arc(
                math.pi, math.pi * 3 / 2
            ).add()
            Circle(ctx).of_center_radius((60, 20), 10).as_arc(
                math.pi * 3 / 2, 0
            ).extend_path().add()
            Circle(ctx).of_center_radius((60, 60), 10).as_arc(
                0, math.pi / 2
            ).extend_path().add()
            Circle(ctx).of_center_radius((20, 60), 10).as_arc(
                math.pi / 2, math.pi
            ).extend_path().fill(Color("red")).stroke(Color("blue"), 5)
            ctx.restore()
            ...
            Circle(ctx).of_center_radius((20, 60), 10).as_arc(
                math.pi / 2, math.pi
            ).extend_path(close=True).fill(Color("red")).stroke(Color("blue"), 5)
            ctx.restore()
    ...
    def test_clip(self):
        def draw(ctx, width, height, frame_no, frame_count):
            ...
            Square(ctx).of_corner_size((1, 1), 0.8).fill(Color("red"))
            Square(ctx).of_corner_size((1, 2), 0.8).fill(Color("green"))
            Square(ctx).of_corner_size((2, 1), 0.8).fill(Color("blue"))
            Square(ctx).of_corner_size((2, 2), 0.8).fill(Color("black"))
            ctx.restore()

            ctx.save()
            Text(ctx).of("ABC", (1.5, 3.5)).font("Times", weight=FONT_WEIGHT_BOLD).size(
                1.5
            ).align_left().align_top().clip()
            circles = [
                (2, 3.8, "orange"),
                (2, 4.5, "cyan"),
                (3, 3.8, "green"),
    ...
    def test_circle(self):
        def draw(ctx, width, height, frame_no, frame_count):
            ...
            Circle(ctx).of_center_radius((4, 1), 0.7).as_arc(0, 1).stroke(
                Color(0, 0.5, 0), 0.05
            )

            Circle(ctx).of_center_radius((1, 2.5), 0.7).as_sector(1, 3).stroke(
                Color("orange"), 0.05
            )
            Circle(ctx).of_center_radius((2.5, 2.5), 0.7).as_sector(2, 4.5).fill(
                Color("cadetblue")
            )
            ...
            Circle(ctx).of_center_radius((1, 4), 0.7).as_segment(1, 3).stroke(
                Color("orange"), 0.05
            )
            Circle(ctx).of_center_radius((2.5, 4), 0.7).as_segment(2, 4.5).fill(
                Color("cadetblue")
            )
    ...
    def draw_regular_polygon(self, ctx, centre, sides, radius, angle):
        ...
        p = (
            RegularPolygon(ctx)
            .of_centre_sides_radius(centre, sides, radius, angle)
    ...
    def test_rectangle(self):
        def draw(ctx, width, height, frame_no, frame_count):
            ...
            Rectangle(ctx).of_corner_size((3, 3), 1.2, 1).fill(Color(0, 0, 1)).stroke(
                Color(0), 0.2
            )
    ...
    def test_square(self):
        def draw(ctx, width, height, frame_no, frame_count):
            ...
            Square(ctx).of_corner_size((3, 3), 1).fill(Color(0, 0, 1)).stroke(
                Color(0), 0.2
            )
    ...
    def test_bezier(self):
        def draw(ctx, width, height, frame_no, frame_count):
            ...
            Bezier(ctx).of_abcd((1, 1.5), (3, 0.5), (2, 2.5), (4, 1.5)).stroke(
                Color("darkgreen"), 0.1
            )
    ...
    def test_text(self):
        def draw(ctx, pixel_width, pixel_height, frame_no, frame_count):
            ...
            Text(ctx).of("Left", (0.5, 0.5)).font("Times").size(
                0.2
            ).align_left().align_baseline().fill(Color("blue"))
            Text(ctx).of("Aligned", (0.5, 0.7)).font("Times").size(
                0.2
            ).align_left().align_baseline().fill(Color("red"))
            Text(ctx).of("Text", (0.5, 0.9)).font("Times").size(
                0.2
            ).align_left().align_baseline().fill(Color("blue"))

            Text(ctx).of("Centre", (2.5, 0.5)).font(
                "Times", weight=FONT_WEIGHT_BOLD
            ).size(0.2).align_center().align_baseline().fill(Color("blue"))
            Text(ctx).of("Aligned", (2.5, 0.7)).font(
                "Times", weight=FONT_WEIGHT_BOLD
            ).size(0.2).align_center().align_baseline().fill(Color("red"))
            Text(ctx).of("Text", (2.5, 0.9)).font(
                "Times", weight=FONT_WEIGHT_BOLD
            ).size(0.2).align_center().align_baseline().fill(Color("blue"))

            Text(ctx).of("Right", (4.5, 0.5)).font(
                "Times", slant=FONT_SLANT_ITALIC
            ).size(0.2).align_right().align_baseline().fill(Color("blue"))
            Text(ctx).of("Aligned", (4.5, 0.7)).font(
                "Times", slant=FONT_SLANT_ITALIC
            ).size(0.2).align_right().align_baseline().fill(Color("red"))
            Text(ctx).of("Text", (4.5, 0.9)).font(
                "Times", slant=FONT_SLANT_ITALIC
            ).size(0.2).align_right().align_baseline().fill(Color("blue"))

            Circle(ctx).of_center_radius((1.9, 2), 0.02).fill(Color(0, 0, 1))
            Text(ctx).of("gTop", (2, 2)).font("Times").size(
                0.2
            ).align_left().align_top().fill(Color("black"))

            Circle(ctx).of_center_radius((1.9, 2.5), 0.02).fill(Color(0, 0, 1))
            Text(ctx).of("gMid", (2, 2.5)).font("Times").size(
                0.2
            ).align_left().align_middle().fill(Color("black"))

            Circle(ctx).of_center_radius((1.9, 3), 0.02).fill(Color(0, 0, 1))
            Text(ctx).of("gBase", (2, 3)).font("Times").size(
                0.2
            ).align_left().align_baseline().fill(Color("black"))

            Circle(ctx).of_center_radius((1.9, 3.5), 0.02).fill(Color(0, 0, 1))
            Text(ctx).of("gBottom", (2, 3.5)).font("Times").size(
                0.2
            ).align_left().align_bottom().fill(Color("black"))
    ...
    def test_text_offset(self):
        def draw(ctx, pixel_width, pixel_height, frame_no, frame_count):
            ...
            Text(ctx).of("B", (200, 200)).font("Arial").offset(100, 20).size(40).fill(
                Color(0)
            )
            Text(ctx).of("C", (200, 200)).font("Arial").offset_angle(1, 150).size(
                40
            ).fill(Color(0))
            Text(ctx).of("D", (200, 200)).font("Arial").offset_towards(
                (100, 150), 50
            ).size(40).fill(Color(0))
    ...
    def test_path(self):
        def draw(ctx, pixel_width, pixel_height, frame_no, frame_count):
            ...
            path2 = (
                Text(ctx)
                .of("Path text", (0, 0))
                .font("Times", weight=FONT_WEIGHT_BOLD)
                .size(0.2)
                .align_left()
                .align_top()
                .path()
    ...
    def test_turtle(self):
        def draw(ctx, pixel_width, pixel_height, frame_no, frame_count):
            ...
            turtle = Turtle(ctx)
            turtle.move_to(100, 100).forward(50).left(math.pi / 2).forward(50).left(
                math.pi / 4
            ).forward(50)

            turtle = Turtle(ctx)
            turtle.move_to(200, 300).set_style(
                Color("green"), line_width=5, dash=[10]
            ).push().forward(100).pop().push().left(3 * math.pi / 4).forward(
                100
            ).pop().right(
                3 * math.pi / 4
            ).forward(
            ...
            turtle = Turtle(ctx)
            turtle.move_to(350, 100).right(math.pi / 2).set_style(
                Color("red"), line_width=5, dash=[10], cap=ROUND
            )
